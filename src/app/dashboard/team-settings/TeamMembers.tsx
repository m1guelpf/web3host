					...
					<Command className="bg-white">
						<CommandList>
							<CommandGroup>
								...
								>
									<p>Member</p>
									<p className="text-sm text-muted-foreground">Can create and deploy sites.</p>
								</CommandItem>
								<CommandItem
								...
								>
									...
									<p className="text-sm text-muted-foreground">
										Can create and deploy sites and manage members.
									</p>
								</CommandItem>
								<CommandItem
									disabled={role != TeamRole.OWNER}
								...
								>
									<p>Owner</p>
									<p className="text-sm text-muted-foreground">
										Can create and deploy sites, manage members, and delete the team.
									</p>
								</CommandItem>
								{member.role != TeamRole.OWNER && (
									<CommandItem
